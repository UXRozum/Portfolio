...
В датасете гораздо больше данных, чем я проанализировал тут. Если вам интересны другие разрезы, или переменные, или перекодировать данные, то вы легко можете скачать почищенные данные [тут](salatyq32024.xlsx).
